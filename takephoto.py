...
try:
    ...
    page_to_scrape.find_element(By.LINK_TEXT, "AOR1").click()
    time.sleep(5)

    link_element = page_to_scrape.find_element(By.XPATH, "/html/body/div[1]/div[2]/div/div[1]/section/div/div/ul/li[2]/div[3]/ul/li[1]/div/div/div[2]/div/a/span")
    link_element.click()
    time.sleep(5)
